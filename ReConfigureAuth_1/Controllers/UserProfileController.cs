...
namespace ReConfigureAuth_1.Controllers
{
    [Authorize]
        ...
        public async Task<string> GetTokenForApplication()
         {
            ...
            AuthenticationContext authenticationContext = new AuthenticationContext(string.Format("https://login.windows.net/{0}", tenantID), new ADALTokenCache(userObjectID));
